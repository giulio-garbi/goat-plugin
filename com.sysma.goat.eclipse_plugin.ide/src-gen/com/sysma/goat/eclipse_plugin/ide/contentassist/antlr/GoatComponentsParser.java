		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getProcessesAlternatives_3_0_0(), "rule__Model__ProcessesAlternatives_3_0_0");
					...
					put(grammarAccess.getEnvInitOrArgAccess().getAlternatives(), "rule__EnvInitOrArg__Alternatives");
					...
					put(grammarAccess.getAtomicOrExprAccess().getAlternatives(), "rule__AtomicOrExpr__Alternatives");
					...
					put(grammarAccess.getAtomicIndexableAccess().getAlternatives(), "rule__AtomicIndexable__Alternatives");
					put(grammarAccess.getOutEqualityComparisonAccess().getAlternatives(), "rule__OutEqualityComparison__Alternatives");
					put(grammarAccess.getOutEqualityComparisonAccess().getAlternatives_1_1(), "rule__OutEqualityComparison__Alternatives_1_1");
					put(grammarAccess.getOutEqualityComparisonAccess().getOpAlternatives_1_1_0_1_0(), "rule__OutEqualityComparison__OpAlternatives_1_1_0_1_0");
					put(grammarAccess.getOutPrimaryAccess().getAlternatives(), "rule__OutPrimary__Alternatives");
					put(grammarAccess.getOutPrimaryAccess().getExpressionAlternatives_0_2_0(), "rule__OutPrimary__ExpressionAlternatives_0_2_0");
					put(grammarAccess.getOutPrimaryAccess().getValueAlternatives_2_1_0(), "rule__OutPrimary__ValueAlternatives_2_1_0");
					put(grammarAccess.getOutAtomicOrRecAccess().getAlternatives(), "rule__OutAtomicOrRec__Alternatives");
					put(grammarAccess.getOutAtomicAccess().getAlternatives(), "rule__OutAtomic__Alternatives");
					put(grammarAccess.getOutAtomicAccess().getValueAlternatives_2_1_0(), "rule__OutAtomic__ValueAlternatives_2_1_0");
					put(grammarAccess.getOutAtomicIndexableAccess().getAlternatives(), "rule__OutAtomicIndexable__Alternatives");
					put(grammarAccess.getFuncStatementAccess().getAlternatives(), "rule__FuncStatement__Alternatives");
					put(grammarAccess.getModelAccess().getGroup(), "rule__Model__Group__0");
					put(grammarAccess.getProcessDefinitionBlkAccess().getGroup(), "rule__ProcessDefinitionBlk__Group__0");
					put(grammarAccess.getProcessDefinitionParAccess().getGroup(), "rule__ProcessDefinitionPar__Group__0");
					...
					put(grammarAccess.getEnvInitValueAccess().getGroup_4(), "rule__EnvInitValue__Group_4__0");
					put(grammarAccess.getEnvInitValueAccess().getGroup_4_2(), "rule__EnvInitValue__Group_4_2__0");
					put(grammarAccess.getEnvInitValueAccess().getGroup_4_2_1(), "rule__EnvInitValue__Group_4_2_1__0");
					put(grammarAccess.getEnvInitOrArgAccess().getGroup_1(), "rule__EnvInitOrArg__Group_1__0");
					...
					put(grammarAccess.getEnvironmentDefinitionAccess().getGroup_2(), "rule__EnvironmentDefinition__Group_2__0");
					put(grammarAccess.getEnvironmentDefinitionAccess().getGroup_2_2(), "rule__EnvironmentDefinition__Group_2_2__0");
					put(grammarAccess.getComponentDefinitionAccess().getGroup(), "rule__ComponentDefinition__Group__0");
					put(grammarAccess.getComponentDefinitionAccess().getGroup_1_0(), "rule__ComponentDefinition__Group_1_0__0");
					put(grammarAccess.getComponentDefinitionAccess().getGroup_1_0_1(), "rule__ComponentDefinition__Group_1_0_1__0");
					put(grammarAccess.getComponentDefinitionAccess().getGroup_1_0_1_2(), "rule__ComponentDefinition__Group_1_0_1_2__0");
					...
					put(grammarAccess.getContainmentExprAccess().getGroup(), "rule__ContainmentExpr__Group__0");
					put(grammarAccess.getContainmentExprAccess().getGroup_1(), "rule__ContainmentExpr__Group_1__0");
					put(grammarAccess.getAtomicOrExprAccess().getGroup_0(), "rule__AtomicOrExpr__Group_0__0");
					...
					put(grammarAccess.getAtomicAccess().getGroup_3_1(), "rule__Atomic__Group_3_1__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_0(), "rule__AtomicIndexable__Group_0__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_0_2(), "rule__AtomicIndexable__Group_0_2__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_0_2_1(), "rule__AtomicIndexable__Group_0_2_1__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_1(), "rule__AtomicIndexable__Group_1__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_2(), "rule__AtomicIndexable__Group_2__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_3(), "rule__AtomicIndexable__Group_3__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_4(), "rule__AtomicIndexable__Group_4__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_4_3(), "rule__AtomicIndexable__Group_4_3__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_4_3_1(), "rule__AtomicIndexable__Group_4_3_1__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_5(), "rule__AtomicIndexable__Group_5__0");
					put(grammarAccess.getOutOrAccess().getGroup(), "rule__OutOr__Group__0");
					put(grammarAccess.getOutOrAccess().getGroup_1(), "rule__OutOr__Group_1__0");
					put(grammarAccess.getOutAndAccess().getGroup(), "rule__OutAnd__Group__0");
					put(grammarAccess.getOutAndAccess().getGroup_1(), "rule__OutAnd__Group_1__0");
					put(grammarAccess.getOutEqualityComparisonAccess().getGroup_1(), "rule__OutEqualityComparison__Group_1__0");
					put(grammarAccess.getOutEqualityComparisonAccess().getGroup_1_1_0(), "rule__OutEqualityComparison__Group_1_1_0__0");
					put(grammarAccess.getOutEqualityComparisonAccess().getGroup_1_1_1(), "rule__OutEqualityComparison__Group_1_1_1__0");
					put(grammarAccess.getOutPrimaryAccess().getGroup_0(), "rule__OutPrimary__Group_0__0");
					put(grammarAccess.getOutPrimaryAccess().getGroup_1(), "rule__OutPrimary__Group_1__0");
					put(grammarAccess.getOutPrimaryAccess().getGroup_2(), "rule__OutPrimary__Group_2__0");
					put(grammarAccess.getOCEAccess().getGroup(), "rule__OCE__Group__0");
					put(grammarAccess.getOutAtomicOrRecAccess().getGroup_0(), "rule__OutAtomicOrRec__Group_0__0");
					put(grammarAccess.getOutAtomicAccess().getGroup_0(), "rule__OutAtomic__Group_0__0");
					put(grammarAccess.getOutAtomicAccess().getGroup_1(), "rule__OutAtomic__Group_1__0");
					put(grammarAccess.getOutAtomicAccess().getGroup_2(), "rule__OutAtomic__Group_2__0");
					put(grammarAccess.getOutAtomicAccess().getGroup_3(), "rule__OutAtomic__Group_3__0");
					put(grammarAccess.getOutAtomicAccess().getGroup_3_1(), "rule__OutAtomic__Group_3_1__0");
					put(grammarAccess.getOutAtomicIndexableAccess().getGroup_0(), "rule__OutAtomicIndexable__Group_0__0");
					put(grammarAccess.getOutAtomicIndexableAccess().getGroup_0_2(), "rule__OutAtomicIndexable__Group_0_2__0");
					put(grammarAccess.getOutAtomicIndexableAccess().getGroup_0_2_1(), "rule__OutAtomicIndexable__Group_0_2_1__0");
					put(grammarAccess.getOutAtomicIndexableAccess().getGroup_1(), "rule__OutAtomicIndexable__Group_1__0");
					put(grammarAccess.getOutAtomicIndexableAccess().getGroup_2(), "rule__OutAtomicIndexable__Group_2__0");
					put(grammarAccess.getOutAtomicIndexableAccess().getGroup_2_3(), "rule__OutAtomicIndexable__Group_2_3__0");
					put(grammarAccess.getOutAtomicIndexableAccess().getGroup_2_3_1(), "rule__OutAtomicIndexable__Group_2_3_1__0");
					put(grammarAccess.getOutAtomicIndexableAccess().getGroup_3(), "rule__OutAtomicIndexable__Group_3__0");
					put(grammarAccess.getOutAtomicIndexableAccess().getGroup_4(), "rule__OutAtomicIndexable__Group_4__0");
					...
					put(grammarAccess.getFuncVarAssignAccess().getGroup_1(), "rule__FuncVarAssign__Group_1__0");
					put(grammarAccess.getFuncVarAppendAccess().getGroup(), "rule__FuncVarAppend__Group__0");
					put(grammarAccess.getFuncVarPopAccess().getGroup(), "rule__FuncVarPop__Group__0");
					...
					put(grammarAccess.getFuncWhileAccess().getGroup(), "rule__FuncWhile__Group__0");
					...
					put(grammarAccess.getProcessDefinitionBlkAccess().getNameAssignment_1(), "rule__ProcessDefinitionBlk__NameAssignment_1");
					put(grammarAccess.getProcessDefinitionBlkAccess().getBlockAssignment_2(), "rule__ProcessDefinitionBlk__BlockAssignment_2");
					put(grammarAccess.getProcessDefinitionParAccess().getNameAssignment_1(), "rule__ProcessDefinitionPar__NameAssignment_1");
					put(grammarAccess.getProcessDefinitionParAccess().getBlockAssignment_3(), "rule__ProcessDefinitionPar__BlockAssignment_3");
					put(grammarAccess.getPDPBlockAccess().getProcsAssignment_0_0(), "rule__PDPBlock__ProcsAssignment_0_0");
					put(grammarAccess.getPDPBlockAccess().getProcsAssignment_1(), "rule__PDPBlock__ProcsAssignment_1");
					put(grammarAccess.getProcessBlockAccess().getStatementsAssignment_2(), "rule__ProcessBlock__StatementsAssignment_2");
					put(grammarAccess.getProcessSpawnAccess().getBlkAssignment_2(), "rule__ProcessSpawn__BlkAssignment_2");
					...
					put(grammarAccess.getReceiveCaseAccess().getSpawnAssignment_7(), "rule__ReceiveCase__SpawnAssignment_7");
					put(grammarAccess.getReceiveCaseAccess().getPrintAssignment_8(), "rule__ReceiveCase__PrintAssignment_8");
					...
					put(grammarAccess.getEnvInitValueAccess().getElemAssignment_4_2_0(), "rule__EnvInitValue__ElemAssignment_4_2_0");
					put(grammarAccess.getEnvInitValueAccess().getElemAssignment_4_2_1_1(), "rule__EnvInitValue__ElemAssignment_4_2_1_1");
					put(grammarAccess.getEnvInitOrArgAccess().getArgAssignment_1_1(), "rule__EnvInitOrArg__ArgAssignment_1_1");
					...
					put(grammarAccess.getEnvParamAccess().getNameAssignment(), "rule__EnvParam__NameAssignment");
					put(grammarAccess.getEnvironmentDefinitionAccess().getNameAssignment_1(), "rule__EnvironmentDefinition__NameAssignment_1");
					put(grammarAccess.getEnvironmentDefinitionAccess().getEnvParamsAssignment_2_1(), "rule__EnvironmentDefinition__EnvParamsAssignment_2_1");
					put(grammarAccess.getEnvironmentDefinitionAccess().getEnvParamsAssignment_2_2_1(), "rule__EnvironmentDefinition__EnvParamsAssignment_2_2_1");
					put(grammarAccess.getEnvironmentDefinitionAccess().getEnvAssignment_3(), "rule__EnvironmentDefinition__EnvAssignment_3");
					put(grammarAccess.getComponentDefinitionAccess().getEnvrefAssignment_1_0_0(), "rule__ComponentDefinition__EnvrefAssignment_1_0_0");
					put(grammarAccess.getComponentDefinitionAccess().getEnvargsAssignment_1_0_1_1(), "rule__ComponentDefinition__EnvargsAssignment_1_0_1_1");
					put(grammarAccess.getComponentDefinitionAccess().getEnvargsAssignment_1_0_1_2_1(), "rule__ComponentDefinition__EnvargsAssignment_1_0_1_2_1");
					...
					put(grammarAccess.getPrimaryAccess().getExpressionAssignment_0_2(), "rule__Primary__ExpressionAssignment_0_2");
					put(grammarAccess.getPrimaryAccess().getExpressionAssignment_1_2(), "rule__Primary__ExpressionAssignment_1_2");
					put(grammarAccess.getContainmentExprAccess().getTupleAssignment_1_2(), "rule__ContainmentExpr__TupleAssignment_1_2");
					...
					put(grammarAccess.getAtomicAccess().getIdxAssignment_3_1_2(), "rule__Atomic__IdxAssignment_3_1_2");
					put(grammarAccess.getAtomicIndexableAccess().getElemAssignment_0_2_0(), "rule__AtomicIndexable__ElemAssignment_0_2_0");
					put(grammarAccess.getAtomicIndexableAccess().getElemAssignment_0_2_1_1(), "rule__AtomicIndexable__ElemAssignment_0_2_1_1");
					put(grammarAccess.getAtomicIndexableAccess().getElemAssignment_1_3(), "rule__AtomicIndexable__ElemAssignment_1_3");
					put(grammarAccess.getAtomicIndexableAccess().getRefAssignment_2_1(), "rule__AtomicIndexable__RefAssignment_2_1");
					put(grammarAccess.getAtomicIndexableAccess().getAttributeAssignment_3_3(), "rule__AtomicIndexable__AttributeAssignment_3_3");
					put(grammarAccess.getAtomicIndexableAccess().getFunctionAssignment_4_1(), "rule__AtomicIndexable__FunctionAssignment_4_1");
					put(grammarAccess.getAtomicIndexableAccess().getParamsAssignment_4_3_0(), "rule__AtomicIndexable__ParamsAssignment_4_3_0");
					put(grammarAccess.getAtomicIndexableAccess().getParamsAssignment_4_3_1_1(), "rule__AtomicIndexable__ParamsAssignment_4_3_1_1");
					put(grammarAccess.getAtomicIndexableAccess().getAttributeAssignment_5_3(), "rule__AtomicIndexable__AttributeAssignment_5_3");
					put(grammarAccess.getOutOrAccess().getSubAssignment_1_2(), "rule__OutOr__SubAssignment_1_2");
					put(grammarAccess.getOutAndAccess().getSubAssignment_1_2(), "rule__OutAnd__SubAssignment_1_2");
					put(grammarAccess.getOutEqualityComparisonAccess().getOpAssignment_1_1_0_1(), "rule__OutEqualityComparison__OpAssignment_1_1_0_1");
					put(grammarAccess.getOutEqualityComparisonAccess().getRightAssignment_1_1_0_2(), "rule__OutEqualityComparison__RightAssignment_1_1_0_2");
					put(grammarAccess.getOutEqualityComparisonAccess().getTupleAssignment_1_1_1_2(), "rule__OutEqualityComparison__TupleAssignment_1_1_1_2");
					put(grammarAccess.getOutPrimaryAccess().getExpressionAssignment_0_2(), "rule__OutPrimary__ExpressionAssignment_0_2");
					put(grammarAccess.getOutPrimaryAccess().getValueAssignment_2_1(), "rule__OutPrimary__ValueAssignment_2_1");
					put(grammarAccess.getOCEAccess().getElemAssignment_1(), "rule__OCE__ElemAssignment_1");
					put(grammarAccess.getOCEAccess().getTupleAssignment_3(), "rule__OCE__TupleAssignment_3");
					put(grammarAccess.getOutAtomicOrRecAccess().getAttributeAssignment_0_3(), "rule__OutAtomicOrRec__AttributeAssignment_0_3");
					put(grammarAccess.getOutAtomicAccess().getValueAssignment_0_1(), "rule__OutAtomic__ValueAssignment_0_1");
					put(grammarAccess.getOutAtomicAccess().getValueAssignment_1_1(), "rule__OutAtomic__ValueAssignment_1_1");
					put(grammarAccess.getOutAtomicAccess().getValueAssignment_2_1(), "rule__OutAtomic__ValueAssignment_2_1");
					put(grammarAccess.getOutAtomicAccess().getIdxAssignment_3_1_2(), "rule__OutAtomic__IdxAssignment_3_1_2");
					put(grammarAccess.getOutAtomicIndexableAccess().getElemAssignment_0_2_0(), "rule__OutAtomicIndexable__ElemAssignment_0_2_0");
					put(grammarAccess.getOutAtomicIndexableAccess().getElemAssignment_0_2_1_1(), "rule__OutAtomicIndexable__ElemAssignment_0_2_1_1");
					put(grammarAccess.getOutAtomicIndexableAccess().getElemAssignment_1_3(), "rule__OutAtomicIndexable__ElemAssignment_1_3");
					put(grammarAccess.getOutAtomicIndexableAccess().getFunctionAssignment_2_1(), "rule__OutAtomicIndexable__FunctionAssignment_2_1");
					put(grammarAccess.getOutAtomicIndexableAccess().getParamsAssignment_2_3_0(), "rule__OutAtomicIndexable__ParamsAssignment_2_3_0");
					put(grammarAccess.getOutAtomicIndexableAccess().getParamsAssignment_2_3_1_1(), "rule__OutAtomicIndexable__ParamsAssignment_2_3_1_1");
					put(grammarAccess.getOutAtomicIndexableAccess().getAttributeAssignment_3_3(), "rule__OutAtomicIndexable__AttributeAssignment_3_3");
					put(grammarAccess.getOutAtomicIndexableAccess().getAttributeAssignment_4_3(), "rule__OutAtomicIndexable__AttributeAssignment_4_3");
					...
					put(grammarAccess.getFuncVarAssignAccess().getIdxAssignment_1_1(), "rule__FuncVarAssign__IdxAssignment_1_1");
					put(grammarAccess.getFuncVarAssignAccess().getValAssignment_3(), "rule__FuncVarAssign__ValAssignment_3");
					put(grammarAccess.getFuncVarAppendAccess().getVarAssignment_0(), "rule__FuncVarAppend__VarAssignment_0");
					put(grammarAccess.getFuncVarAppendAccess().getItemAssignment_4(), "rule__FuncVarAppend__ItemAssignment_4");
					put(grammarAccess.getFuncVarPopAccess().getVarAssignment_0(), "rule__FuncVarPop__VarAssignment_0");
					...
					put(grammarAccess.getFuncWhileAccess().getCondAssignment_2(), "rule__FuncWhile__CondAssignment_2");
					put(grammarAccess.getFuncWhileAccess().getCycleAssignment_4(), "rule__FuncWhile__CycleAssignment_4");
				}
			};
		}
