		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOutEqualityComparisonAccess().getOpAlternatives_1_2_0(), "rule__OutEqualityComparison__OpAlternatives_1_2_0");
					...
					put(grammarAccess.getAtomicIndexableAccess().getGroup_5_3(), "rule__AtomicIndexable__Group_5_3__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_5_3_1(), "rule__AtomicIndexable__Group_5_3_1__0");
					put(grammarAccess.getAtomicIndexableAccess().getGroup_6(), "rule__AtomicIndexable__Group_6__0");
					...
					put(grammarAccess.getAtomicIndexableAccess().getElemAssignment_2_3(), "rule__AtomicIndexable__ElemAssignment_2_3");
					put(grammarAccess.getAtomicIndexableAccess().getIdxAssignment_2_5(), "rule__AtomicIndexable__IdxAssignment_2_5");
					put(grammarAccess.getAtomicIndexableAccess().getRefAssignment_3_1(), "rule__AtomicIndexable__RefAssignment_3_1");
					put(grammarAccess.getAtomicIndexableAccess().getAttributeAssignment_4_3(), "rule__AtomicIndexable__AttributeAssignment_4_3");
					put(grammarAccess.getAtomicIndexableAccess().getFunctionAssignment_5_1(), "rule__AtomicIndexable__FunctionAssignment_5_1");
					put(grammarAccess.getAtomicIndexableAccess().getParamsAssignment_5_3_0(), "rule__AtomicIndexable__ParamsAssignment_5_3_0");
					put(grammarAccess.getAtomicIndexableAccess().getParamsAssignment_5_3_1_1(), "rule__AtomicIndexable__ParamsAssignment_5_3_1_1");
					put(grammarAccess.getAtomicIndexableAccess().getAttributeAssignment_6_3(), "rule__AtomicIndexable__AttributeAssignment_6_3");
					...
					put(grammarAccess.getOutEqualityComparisonAccess().getLeftAssignment_1_1(), "rule__OutEqualityComparison__LeftAssignment_1_1");
					put(grammarAccess.getOutEqualityComparisonAccess().getOpAssignment_1_2(), "rule__OutEqualityComparison__OpAssignment_1_2");
					put(grammarAccess.getOutEqualityComparisonAccess().getRightAssignment_1_3(), "rule__OutEqualityComparison__RightAssignment_1_3");
					put(grammarAccess.getOutPrimaryAccess().getExpressionAssignment_1_2(), "rule__OutPrimary__ExpressionAssignment_1_2");
