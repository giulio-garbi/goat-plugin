		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInputProcessAccess().getOutputAssignment_8(), "rule__InputProcess__OutputAssignment_8");
					...
					put(grammarAccess.getOutputProcessPartAccess().getOutputAssignment_8(), "rule__OutputProcessPart__OutputAssignment_8");
					...
					put(grammarAccess.getPrintFormattedStatementAccess().getToPrintAssignment_3(), "rule__PrintFormattedStatement__ToPrintAssignment_3");
