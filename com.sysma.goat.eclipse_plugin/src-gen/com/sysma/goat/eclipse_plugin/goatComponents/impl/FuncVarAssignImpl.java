...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Func Var Assign</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class FuncVarAssignImpl extends FuncStatementImpl implements FuncVarAssign
{
  /**
  ...
  {
    return GoatComponentsPackage.Literals.FUNC_VAR_ASSIGN;
  }
    ...
    if (var != null && var.eIsProxy())
    {
      ...
      if (var != oldVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, GoatComponentsPackage.FUNC_VAR_ASSIGN__VAR, oldVar, var));
      }
    }
    return var;
  }
  ...
  public void setVar(FuncVarDeclaration newVar)
  {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GoatComponentsPackage.FUNC_VAR_ASSIGN__VAR, oldVar, var));
  }
  ...
  public NotificationChain basicSetVal(Expression newVal, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GoatComponentsPackage.FUNC_VAR_ASSIGN__VAL, oldVal, newVal);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setVal(Expression newVal)
  {
    if (newVal != val)
    {
      NotificationChain msgs = null;
      if (val != null)
        msgs = ((InternalEObject)val).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GoatComponentsPackage.FUNC_VAR_ASSIGN__VAL, null, msgs);
      if (newVal != null)
        msgs = ((InternalEObject)newVal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GoatComponentsPackage.FUNC_VAR_ASSIGN__VAL, null, msgs);
      msgs = basicSetVal(newVal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GoatComponentsPackage.FUNC_VAR_ASSIGN__VAL, newVal, newVal));
  }
